...
class Mcda(QgsProcessingAlgorithm):
    def initAlgorithm(self, config=None):  # noqa: N802
        self.addParameter(
            QgsProcessingParameterRasterLayer(
                "Economicsuitability", "Economic suitability", defaultValue=None
            )
        )
        self.addParameter(
            QgsProcessingParameterNumber(
                "WeightforEconomicsuitability",
                "Weight for Economic suitability",
        ...
        self.addParameter(
            QgsProcessingParameterNumber(
                "WeightforEnvironmentalsuitability",
                "Weight for Environmental suitability",
                type=QgsProcessingParameterNumber.Double,
                minValue=0,
                maxValue=1,
                defaultValue=0.333,
        ...
        self.addParameter(
            QgsProcessingParameterRasterLayer(
                "Socialsuitability", "Social suitability", defaultValue=None
            )
        )
        self.addParameter(
            QgsProcessingParameterNumber(
                "WeightforSocialsuitability",
                "Weight for Social suitability",
                type=QgsProcessingParameterNumber.Double,
                minValue=0,
                maxValue=1,
                defaultValue=0.3333,
        ...
        self.addParameter(
            QgsProcessingParameterRasterDestination(
                "Mcda", "MCDA", createByDefault=True, defaultValue=None
            )
        )
    ...
    def processAlgorithm(self, parameters, context, model_feedback):  # noqa: N802
        ...
        alg_params = {
            ...
            "EXTRA": "",
            "INPUT": QgsExpression(
                "array( @Economicsuitability , @Environmentalsuitability , @Socialsuitability )"  # noqa
            ).evaluate(),
            "NODATA_INPUT": None,
            "NODATA_OUTPUT": None,
            "OPTIONS": "",
        ...
        alg_params = {
            ...
            "FORMULA": QgsExpression(
                "concat('A*',to_string( @WeightforEconomicsuitability ),' + B*', to_string( @WeightforEnvironmentalsuitability ),' + C*',to_string( @WeightforSocialsuitability ))"  # noqa
            ).evaluate(),
