...
<p>This algorithm creates a composite general suitability index for educational facilities in a particular region. It considers the suitability of a location depending on the results from the three previous suitability rasters (economic, environmental, and social). The user can define custom weights for each input. The result produces a raster ranging from 1 to 4, where 1 is Less suitable and 4 is More suitable.</p>
<h2>Input parameters</h2>
<h3>Economic suitability</h3>
<p>Raster layer ranging from 1 (More suitable) to 4 (Less suitable), created using the Economic suitability algorithm.</p>
<h3>Weight for Economic suitability</h3>
<p>Make sure that the sum of "Weight for economic suitability", "Weight for environmental suitability", and "Weight for social suitability" is equal to 100%.</p>
<h3>Environmental suitability</h3>
<p>Raster layer ranging from 1 (More suitable) to 4 (Less suitable), created using the Environmental suitability algorithm.</p>
<h3>Weight for Environmental suitability</h3>
<p>Make sure that the sum of "Weight for economic suitability", "Weight for environmental suitability", and "Weight for social suitability" is equal to 100%.</p>
<h3>Social suitability</h3>
<p>Raster layer ranging from 1 (More suitable) to 4 (Less suitable), created using the Social suitability algorithm.</p>
